    ...
    const testimonials = [
        {
            ...
            content: "PostureAI has revolutionized how I help patients improve their posture. The real-time feedback is incredibly accurate.",
            rating: 5
        },
        {
            name: "Chetan Sharma",
            role: "Fitness Trainer",
            content: "My clients love the instant feedback during workouts. It's like having a posture coach available 24/7.",
            rating: 4
        },
        {
            name: "Pooja Verma",
            role: "Office Worker",
            content: "Since using PostureAI, my back pain has significantly reduced. The desk posture analysis is a game-changer.",
            rating: 5
        }
    ];
                ...
                <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                                Join thousands of satisfied users who have improved their posture and reduced pain with PostureAI.
                            </p>
                        </div>

                        <div className="grid md:grid-cols-3 gap-8">
                            {testimonials.map((testimonial, index) => (
                                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-white/10 rounded-xl p-6">
